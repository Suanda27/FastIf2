                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm font-medium text-gray-600 mb-1">Nomor Surat</p>
                      <p className="text-base sm:text-lg font-bold text-[#0A1C56] break-all">{surat.nomorSurat}</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm font-medium text-gray-600 mb-1">Jenis Surat</p>
                      <p className="text-base sm:text-lg font-semibold text-[#0A1C56]">{surat.jenisSurat}</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm font-medium text-gray-600 mb-1">Tanggal Pengajuan</p>
                      <p className="text-base sm:text-lg font-semibold text-[#0A1C56]">{surat.tanggal}</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm font-medium text-gray-600 mb-1">Keterangan</p>
                      <p className="text-sm sm:text-base text-gray-700">
                        Surat telah diproses dan dapat diambil di bagian administrasi.
                      </p>
                    </div>
                  </motion.div>
                </div>
